...
public class RegisterActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText nameInput = (EditText) findViewById(R.id.nameInput_register);
        final EditText emailInput = (EditText) findViewById(R.id.emailInput_register);
        final EditText passInput = (EditText) findViewById(R.id.passInput_register);
